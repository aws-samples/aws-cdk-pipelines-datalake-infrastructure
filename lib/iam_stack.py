...
from .configuration import (
    get_mappings, get_logical_id_prefix, get_resource_name_prefix
)


class IamStack(Stack):

    def __init__(self, scope: Construct, construct_id: str, target_environment: str, deployment_account_id: str, **kwargs) -> None:
